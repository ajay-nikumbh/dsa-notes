...
# LeetCode examples: triangle with an extra edge is not bipartite, a 4-cycle is
...
# Disconnected graph -> each component is colored independently, both bipartite
assert sol.isBipartite([[1], [0], [3], [2]]) == True

# Odd-length cycle (triangle) -> can never be 2-colored -> not bipartite
assert sol.isBipartite([[1, 2], [0, 2], [0, 1]]) == False

# Even-length cycle -> colors alternate and close consistently -> bipartite
assert sol.isBipartite([[1, 3], [0, 2], [1, 3], [0, 2]]) == True
