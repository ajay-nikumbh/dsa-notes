...
Output: 3
Explanation: There are 3 islands, all of different shapes, so distinct
islands = 3.
```
...
No other unvisited land remains -> answer = 2 shapes for this particular grid
(note: differs from the LeetCode Example 2 grid shown above, which yields 3;
this walk-through uses a smaller illustrative grid)
```
