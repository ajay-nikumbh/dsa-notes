...
# No edges at all: no traversal ever finds a back edge; also verifies isolated vertices don't crash
adj4 = build_adj(3, [])
...
# Disconnected components: one acyclic component ({1..7}, with a cross edge at 5) + one cyclic component ({8,9,10})
adj6 = build_adj(
    11,
    [
